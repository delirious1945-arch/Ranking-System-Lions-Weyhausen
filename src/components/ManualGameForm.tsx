            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                    ...
                    <div style={cardStyle}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 0.8fr 1fr 1fr', gap: '12px' }}>
                            ...
                            <select value={formData.spieltag_num} onChange={e => set('spieltag_num', parseInt(e.target.value))} style={inputGlassStyle}>
                                {[...Array(20)].map((_, i) => <option key={i+15} value={i+15} style={{ background: '#0f172a' }}>Spieltag {i+15}</option>)}
                            </select>
