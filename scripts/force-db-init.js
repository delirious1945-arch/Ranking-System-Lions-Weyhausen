...
async function createTableForce() {
    ...
    try {
        ...
        `);
        console.log("Table 'MatchRecord' created or already exists.");
        
        await prisma.$executeRawUnsafe(`CREATE INDEX IF NOT EXISTS "MatchRecord_playerName_spieltag_idx" ON "MatchRecord"("playerName", "spieltag");`);
        await prisma.$executeRawUnsafe(`CREATE INDEX IF NOT EXISTS "MatchRecord_eventId_spieltag_idx" ON "MatchRecord"("eventId", "spieltag");`);
